...
#define PR_DOWN_KEY			_Key_Cam_Ctrl_Wide
#define PR_DOWN_LED			_Led_Cam_Ctrl_Wide
#define PR_UP_KEY			_Key_Cam_Ctrl_Tele
#define PR_UP_LED			_Led_Cam_Ctrl_Tele
